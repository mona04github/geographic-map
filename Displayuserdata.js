...
//         <button className='btn' onClick={() => handleClick(user)}>Summary</button>
//           </div>
//         </div>
//       ))}
...
//           <a href={selectedUser.coordinates}></a>
//          {/* <p> <iframe src= {selectedUser.coordinates} width="600" height="450" style={{ border: "0" }} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p> */}
//           <button type = 'button'onClick={() => setSelectedUser(null)}>Close Profile</button>
//         </div>
//       )}
//     </div>
//     </div>
